...
class Tank {
  ...
  void display() {
    ...
    stroke(0.2);
    fill(100, 100, 100);
    rect(size * 0.36, 0, size * 0.71, size * 0.1);
    rect(0, 0, size * 0.6, size * 0.4);
    noStroke();
    rect(size * 0.35, 0, size * 0.7, size * 0.09);
    stroke(0.2);
    popMatrix();
